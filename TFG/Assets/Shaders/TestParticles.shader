    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_959 = saturate((((1.0 - _Displacement)*0.96+-0.48)+_node_7414_var.r));
                clip(node_959 - 0.5);
////// Lighting:
////// Emissive:
                ...
                float3 emissive = ((_ControlDeath*(node_1203.rgb*3.0))+((_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb)*(_MainTex_var.a*_Color.a*i.vertexColor.a)));
